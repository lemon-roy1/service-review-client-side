...
const Home = () => {
    ...
    return (
        <div>
            ...
            <div className="hero lg:h-90 ">
                <div className="hero-content lg:h-90 flex-col lg:flex-row">
                    <img src={d} alt="img" className=" h-80 rounded-lg shadow-2xl" />
                    <div className='lg:ml-10'>
                        <h1 className="text-5xl font-bold">today from your <br /> favorite camara man<br /> to your table</h1>
                        <p className="py-6">Find the perfect photo, shopkeeper camara man, image, vector, illustration or 360 image. Available for both RF and RM licensingFind the perfect food, shopkeeper stock photo, image, vector, illustration or 360 image. Available for both RF and RM licensing</p>
            ...
            <div className='grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3  mb-15 '>
                ...
                <div className="card w-90  ">
                    <img className='w-[350px]' src={p3} alt="" />
                    <div className=" text-3xl text-center ">Wait for delivery</div>
                    <p className='text-center'>That could be because people can't or don't want to wait for a delivery van to show up.</p>
                </div>
            </div>
